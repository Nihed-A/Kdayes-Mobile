...
public class ServiceReclamation {
    ...
    public void ajoutReclamation(Reclamation reclamation) {
        ...
        String url =Statics.BASE_URL+"/addReclamation?objet="+reclamation.getObj()+"&description="+reclamation.getRec()+"&user="+reclamation.getIdUtl(); // aa sorry n3adi getId lyheya mech ta3 user ta3 reclamation
            ...
            public void actionPerformed(NetworkEvent evt) {
                ...
                try {
                    ...
                    for(Map<String, Object> obj : listOfMaps) {
                        ...
                        String objet = obj.get("obj").toString();
                        
                        String description = obj.get("rec").toString();
                        String type = obj.get("type").toString();
//                        float etat = Float.parseFloat(obj.get("etat").toString());
                        
                        re.setIdRec((int)id);
                        re.setObj(objet);
                        re.setRec(description);
                        re.setType(type);
...
//                        //insert data into ArrayList result
    ...
    public Reclamation DetailRecalamation( int id , Reclamation reclamation) {
        ...
        req.addResponseListener(((evt) -> {
            ...
            try {
                ...
                reclamation.setObj(obj.get("obj").toString());
                reclamation.setRec(obj.get("description").toString());
    ...
    public boolean modifierReclamation(Reclamation reclamation) {
        String url = Statics.BASE_URL +"/updateReclamation?id="+reclamation.getIdRec()+"&objet="+reclamation.getObj()+"&description="+reclamation.getRec()+"&etat="+reclamation.getType();
        req.setUrl(url);
