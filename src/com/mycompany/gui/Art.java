...
//    private Toolbar tb;
    ...
    public Art (Resources res,Form previous) {
        instance=this;
//        super(BoxLayout.y());
...
//     SpanLabel SLdesc = new SpanLabel(p.getDescription());
    //  SpanLabel SLrem = new SpanLabel(p.getAuteur());
        ...
        Button ModAr = new Button();
        ModAr.setMaterialIcon(FontImage.MATERIAL_UPDATE);
        ModAr.addActionListener(e->new ModArt(res,current).show());
        
        Button supp = new Button();
        supp.setMaterialIcon(FontImage.MATERIAL_DELETE);
        supp.addActionListener(e->new DelArt(res,current).show());
