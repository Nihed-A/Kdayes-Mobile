...
import static com.mycompany.services.ServiceReclamation.instance;
...
//          super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        ...
        current = this ;
        setToolbar(tb);
//        Button SLvoir = new Button("Ajouter reclamation");
...
//        rbs[0].setSelected(true);
        ...
        for(Reclamation rec : list ) {
             ...
             Container cnr = new Container(BoxLayout.x());
             Label label = new Label(rec.getObj());
             Label label1 = new Label(rec.getRec());
             Label label2 = new Label(rec.getType());
            Label label3 = new Label(rec.getIdRec()+"");
             Label label4 = new Label(rec.getIdUtl()+"");
             cnr.addAll(label3,label,label1,label2,label4);
        ...
        Button SLvoir = new Button("Ajouter reclamation");
        SLvoir.addActionListener(e->new AjouterReclamation(res,current).show());
        add(SLvoir);
    ...
    ListReclamationForm(Resources res, Form previous) {
...
////        Label objetTxt = new Label("Date : "+rec.getDate(),"NewsTopLine2");
        Label dateTxt = new Label("objet : "+rec.getObj(),"NewsTopLine2");
        Label etatTxt = new Label("etat : "+rec.getRec(),"NewsTopLine2" );
...
//            etatTxt.setText("Traitée");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce reclamation ?","Annuler","Oui")) {
                ...
                if(ServiceReclamation.getInstance().deleteReclamation(1)) {
