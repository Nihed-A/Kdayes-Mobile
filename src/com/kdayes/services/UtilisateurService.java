...
public class UtilisateurService {
    ...
    private Utilisateur getOne() {
        try {
            ...
            return new Utilisateur(
                    ...
                    (String) obj.get("nom"),
                    (int) Float.parseFloat(obj.get("telephone").toString()),
                    Float.parseFloat(obj.get("solde").toString())
    ...
    public int manage(Utilisateur utilisateur, boolean isEdit) {
        ...
        cr.addArgument("roles", utilisateur.getRoles());
        cr.addArgument("password", utilisateur.getPassword());
        cr.addArgument("nom", utilisateur.getNom());
        cr.addArgument("telephone", String.valueOf(utilisateur.getTelephone()));
        cr.addArgument("solde", String.valueOf(utilisateur.getSolde()));
