...
public class AccueilBack extends Form {
    ...
    private Button makeCategoriesButton() {
        ...
        button.addActionListener(action -> new com.kdayes.gui.back.categorie.ShowAll(this).show());
        return button;
    }
    private Button makeEvenementsButton() {
        ...
        button.setUIID("buttonMenu");
        button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.kdayes.gui.back.evenement.ShowAll(this).show());
        return button;
    }
